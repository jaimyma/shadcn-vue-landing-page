    ...
    >
      <div class="text-center space-y-8">
        ...
        <p class="max-w-screen-sm mx-auto text-xl text-muted-foreground">
          Your personal AI coach pushes you to train harder, smarter, and with purpose. No generic plans — just tailored progress, every single day.
        </p>

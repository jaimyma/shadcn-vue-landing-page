...
const teamList: TeamProps[] = [
  {
    ...
    firstName: "Jaimy",
    lastName: "Mathon",
    positions: ["Student Software Developer", "Creator Of This Website"],
    socialNetworks: [
      {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/jaimymathon/",
      },
      {
        name: "Github",
        url: "https://github.com/jaimymathon",
      },
      {
        name: "X",
        url: "https://x.com/jaimymathon",
      },
    ],
  },
  // {
